...
void setup() {
  Serial.begin(115200);
  SerialBT.begin("ESP32_BT_1"); //change to 2 for other one
  Serial.println("bluetooth device is ready to pair || bt name: ESP32_BT_1"); //change to 2 for the other one
